...
final class SimpleMySQLQuery extends Connector
{
    const TYPE_ONE = 1;
    const TYPE_ALL = 2;
     ...
     * @throws \ReflectionException
     */
    private function verifyPropertyRelational(\mysqli_stmt $rows, $class, array $properties, $skip_relation = false)
    {
